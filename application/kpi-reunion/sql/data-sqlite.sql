...
INSERT INTO event_details (name, adult_fee, child_fee, created, updated, is_deleted, is_default, uuid) VALUES ("রংপুর পলিটেকনিক ইনস্টিটিউট পুনর্মিলনী - ২০২৩", 750, 600, strftime('%Y-%m-%d %H:%M:%S','now'), strftime('%Y-%m-%d %H:%M:%S','now'), 0, 1, '80B2E23A-7E38-11ED-A7BB-8X2AFD1190BD');
